...
type BlogListClientProps = {
	initialItems: BlogIndexItem[]
}

export default function BlogListClient({ initialItems }: BlogListClientProps) {
	...
	const [editableItems, setEditableItems] = useState<BlogIndexItem[]>(initialItems)
					...
					<div className='text-center'>
						{hasMoreItems && (
							<motion.button
								...
								<div className='pt-12'>
									{items.length === 0 && <div className='text-secondary py-6 text-center text-sm'>{t('blog.noArticles')}</div>}
								</div>
